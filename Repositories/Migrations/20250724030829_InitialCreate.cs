        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFee = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendationType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    RecommendationData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_CustomDesignId",
                table: "OrderItems",
                column: "CustomDesignId");
